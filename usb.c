...
PHP_FUNCTION(usb_has_capability)
{
	...
	php_error(E_WARNING, "usb_has_capability: not yet implemented"); RETURN_FALSE;
...
PHP_FUNCTION(usb_get_device_descriptor)
{
	...
	php_error(E_WARNING, "usb_get_device_descriptor: not yet implemented"); RETURN_FALSE;
...
PHP_FUNCTION(usb_get_active_config_descriptor)
{
	...
	php_error(E_WARNING, "usb_get_active_config_descriptor: not yet implemented"); RETURN_FALSE;
...
PHP_FUNCTION(usb_get_config_descriptor)
{
	...
	php_error(E_WARNING, "usb_get_config_descriptor: not yet implemented"); RETURN_FALSE;
...
/* {{{ proto usb_get_config_descriptor_by_value(resource usb_device device, int bConfigurationValue, mixed &config_descriptor)
   */
PHP_FUNCTION(usb_get_config_descriptor_by_value)
{
	...
	php_error(E_WARNING, "usb_get_config_descriptor_by_value: not yet implemented"); RETURN_FALSE;

}
/* }}} usb_get_config_descriptor_by_value */


/* {{{ proto void usb_free_config_descriptor(resource usb_config_descriptor config_descriptor)
   */
PHP_FUNCTION(usb_free_config_descriptor)
{
	...
	ZEND_FETCH_RESOURCE(res_config_descriptor, struct libusb_config_descriptor *, &config_descriptor, config_descriptor_id, "usb_config_descriptor", le_usb_config_descriptor);
...
PHP_FUNCTION(usb_get_string_descriptor_ascii)
{
	...
	php_error(E_WARNING, "usb_get_string_descriptor_ascii: not yet implemented"); RETURN_FALSE;
...
PHP_FUNCTION(usb_get_descriptor)
{
	...
	php_error(E_WARNING, "usb_get_descriptor: not yet implemented"); RETURN_FALSE;
