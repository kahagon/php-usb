...
PHP_FUNCTION(usb_get_device_descriptor)
{
	...
	libusb_device_descriptor libusb_resource_device_descriptor;
	int result;
	...
	if (result == LIBUSB_SUCCESS) {
		store_device_descriptor_to_zval(&libusb_resource_device_descriptor, zval_object_device_descriptor, INTERNAL_FUNCTION_PARAM_PASSTHRU);
	}
...
PHP_FUNCTION(usb_get_active_config_descriptor)
{
	...
	zval zval_resource_config_descriptor;
	phpusb_register_resource(&zval_resource_config_descriptor, libusb_resource_config_descriptor, le_usb_config_descriptor);
